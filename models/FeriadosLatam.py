...
class Feriados_Latam:
    ...
    def colombia(self):
        ...
        indepen = self.date_format(self.dinamico_colombia(datetime.date(self.year, 11, 11)))
        lista = [(1,1),r_mag,s_jose,j_santo,v_santo,d_resu,(5,1), d_ascen, c_christi, s_corazon,s_pedro,(7,20),(8,7),v_asun,d_ra,d_santos,indepen,(12,8),(12,25)]
    ...
    def salvador(self):      
        ...
        lista = [(1,1),j_santo,v_santo,s_santo,d_resu,(5,1),(5,10),(6,17),(8,5),(8,6),(9,15),(11,2),(12,25)]
    ...
    def honduras(self):      
        ...
        d_ra = self.date_format(self.dinamico_colombia(self.dia_raza))
        d_fuer = self.date_format(self.dinamico_colombia(datetime.date(self.year, 10, 21)))
        
        lista = [(1,1),j_santo,v_santo,s_santo,d_resu,d_america,(5,1),(9,15),(10,3),d_ra,d_fuer,(12,25)]
    ...
    def nicaragua(self):      
        ...
        lista = [(1,1),j_santo,v_santo,d_resu,(5,1),(7,19),(9,14),(9,15),(12,8),(12,25)]
    ...
    def venezuela(self):
        ...
        lista = [(1,1),l_carna,m_carna,j_santo,v_santo,d_resu,(4,19),(5,1),(6,24),(7,5),(7,24),(10,12),(12,24),(12,25),(12,31)]
